...
export default function SignIn(props: Props) {
    ...
    const { currentSignInInput } = useSelector((state: RootState) => state.auth)

    const { username, password, rememberMe } = currentSignInInput
    ...
    const handleCheckboxChange = (event: React.ChangeEvent, checked: boolean) =>
        dispatch(
            setCurrentSignInInput({
                ...currentSignInInput,
                rememberMe: checked,
