...
import { doLogin, handleForgotPassword, resetForgotPasswordInput, setCurrentForgotPasswordInput } from './AuthSlice';
...
export default function ForgotPassword(props: Props) {
  ...
  const handleChange = (e: any) => dispatch(setCurrentForgotPasswordInput({
    ...currentForgotPasswordInput,
